...
describe "App rules":
  ...
  it "validates a single app rule":
    let testToml: string = """
    [[appRule]]
  ...
  it "raises an exception if a rule has an invalid title":
    let testToml: string = """
    [[appRule]]
    title = 9009
    class = "123"
  ...
  it "raises an exception if a rule has an invalid class":
    let testToml: string = """
    [[appRule]]
    class = 123
    instance = "element"
  ...
  it "raises an exception if a rule has an invalid instance":
    let testToml: string = """
    [[appRule]]
    class = "Element"
    instance = 142
  ...
  it "raises an exception if a rule has an invalid monitor":
    let testToml: string = """
    [[appRule]]
    class = "Element"
    instance = "element"
  ...
  it "raises an exception if a rule has an invalid tags array":
    let testToml: string = """
    [[appRule]]
    class = "Element"
    instance = "element"
